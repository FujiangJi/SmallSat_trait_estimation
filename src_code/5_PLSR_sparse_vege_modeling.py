...
data_path1 = "/mnt/cephfs/scratch/groups/chen_group/FujiangJi/SmallSat_data/2_high_resolution_trait_maps/5_extract_training_samples/0_sparse_vagetated_area/1_EMIT_points_final.csv"
data_path2 = "/mnt/cephfs/scratch/groups/chen_group/FujiangJi/SmallSat_data/2_high_resolution_trait_maps/5_extract_training_samples/0_sparse_vagetated_area/1_HR_points_final.csv"
out_path = "/mnt/cephfs/scratch/groups/chen_group/FujiangJi/SmallSat_data/6_spase_vege_modeling_results/"
...
for arch in models:    
    ...
    if arch == "SSFCNN":
        ...
        cols = [x for x in df.columns if "EMIT" in x and "EMIT_NDVI" not in x]
    elif arch == "Planet":
        cols = [x for x in df.columns if "Planet" in x and "Planet_NDVI" not in x]
    else:
    ...
    for tr in traits:
        ...
        # data = data.iloc[0:100, :]             #*********************For Testing code*********************#
